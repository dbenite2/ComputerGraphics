...
public class Gancho extends JPanel implements KeyListener{
    ...
    public Gancho (Point [] arrPoints, Point [] arrDirs){
    ...
    public void paintG(Graphics2D g2d){
        for(int i = 0; i < arrDirs.length; i++){
            ...
            int end = s.getY();
            g2d.setColor(Color.BLACK);
            g2d.drawLine(this.arrPoints[init].getX() + 250 , 250 - this.arrPoints[init].getY(), this.arrPoints[end].getX() + 250 , 250 - this.arrPoints[end].getY());
